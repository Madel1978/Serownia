...
from PyQt5.QtWidgets import (
    QLineEdit, QLabel, QPushButton, QWidget, QMessageBox,
...
class LoginScreen(BackgroundScreen):
    ...
    def __init__(
        ...
        user_icon_path = r"c:\serownia\images\user_icon.png"  # <-- Dostaw faktyczną ścieżkę do pliku
    ...
    def attempt_login(self) -> None:
        ...
        if self.db_manager and self.db_manager.verify_user(username, password):
            ...
            if hasattr(mw, 'login_user'):
                ...
                QMessageBox.warning(self, "Błąd", "Brak metody window().login_user – nie można kontynuować.")
        else:
            QMessageBox.warning(self, "Błąd", "Niepoprawna nazwa użytkownika lub hasło.")
    ...
    def go_to_registration(self) -> None:
        ...
        if hasattr(mw, 'show_screen') and hasattr(mw, 'registration_screen'):
            ...
            QMessageBox.warning(self, "Błąd", "Brak ekranu rejestracji lub metody show_screen w oknie głównym.")
